                        ...
                        html.Div(className = "block flex-container", children=[
                                html.Div(className="block flex-container-options text-white bg-primary",children=[
                                        ...
                                        html.Div(className="item3-options",children=[
                                                ...
                                                html.Br(),
                                                html.Div([html.Button('Predict multiple locations', id='predict_multiple_locations', n_clicks=0, hidden = False,
                                                                     className="myButton2", style={'width': 'auto'}),
                                                          html.Br(),
                                                          html.Br(),
                                                          html.Button('Predict single location', id='predict_single_location', n_clicks=0, hidden = False,
                                                                    className="myButton2", style={'width': 'auto','textAlign':'center'})],
                                        ...
                                        html.Div(className='item5-options',children=[
                                                ...
                                                html.Div([
                                                    html.Button('Download working data', id='btn_csv', n_clicks=0, 
                                                                      className="myButton2",style={'width': 'auto'}
                                                        ),
                                                      html.Br(),
                                                          html.Br(),
...
login_layout = html.Div([dbc.Row(html.Div(className="app-div--titlenav",children=
                                html.Nav(className="navbar navbar-expand-lg navbar-dark bg-primary ",children=
                                        html.Div(className="container-fluid", children=[
                                            html.A("Boosterpack Sample", className="navbar-brand", href="#"),
                                        ])
